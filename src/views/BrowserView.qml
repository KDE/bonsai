...
showCSDControls: true
    ...
    headBar.middleContent: Maui.TextField
    {
        ...
        placeholderText: i18np("Filter", "Filter %1 repos", control.model.list.count);
    ...
    headBar.rightContent:[
        ...
        {
            id: _viewMenu
            icon.name: control.viewType === Maui.AltBrowser.List ? "view-list-details" : "view-list-icons"
            ...
            Maui.MenuItemActionRow
            {
                Action
                {
                    ...
                    checked: control.viewType === Maui.AltBrowser.List
                    checkable: true
                    onTriggered: control.viewType = Maui.AltBrowser.List
                }
                ...
                Action
                {
                    ...
                    checked: control.viewType === Maui.AltBrowser.Grid
                    checkable: true
                    onTriggered: control.viewType = Maui.AltBrowser.Grid
                }
            }
